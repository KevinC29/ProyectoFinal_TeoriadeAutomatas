...
datos_entrenamiento = '/Users/danixasolano/Downloads/KEVYN/Proyecto/Fotos/Entrenamiento'
datos_validacion = '/Users/danixasolano/Downloads/KEVYN/Proyecto/Fotos/Validacion'
...
filtroconv3 = 128 
tam_filtro1 = (4,4)   #Tamaños de los filtros 1,2,3
tam_filtro2 = (3,3)
tam_filtro3 = (2,2)
...
cnn.add(Convolution2D(filtroconv2, tam_filtro2, padding = 'same', activation = 'relu')) #Se agrega la 2da capa
cnn.add(MaxPooling2D(pool_size = tam_pool))
cnn.add(Convolution2D(filtroconv3, tam_filtro3, padding = 'same', activation = 'relu')) #Se agrega la 3ra capa
cnn.add(MaxPooling2D(pool_size = tam_pool))
...
cnn.add(Dense(3072,activation='relu')) #Asignamos 3072 neuronas 256 para ambas manos
